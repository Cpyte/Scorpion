...
/*
 * ESP32-C3 UART0 console.
 *
 * The boot ROM leaves UART0 running at 115200 8n1 with its default
 * clock configuration, and every Espressif dev-board wires UART0 to
 * the on-board USB-serial bridge. Scorpion therefore does not touch
 * CLKDIV/CONF0 at all — it just polls the TX FIFO for space. If you
 * reconfigure the clock tree before console_init(), set CLKDIV here.
 */
